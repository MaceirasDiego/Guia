 ...
 * @author info6
 */
public class CuadrosCombinados4 extends javax.swing.JFrame {

    /**
     * Creates new form CuadrosCombinados
     */
    public CuadrosCombinados4() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuadrosCombinados4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CuadrosCombinados4().setVisible(true);
            }
        });
    }
