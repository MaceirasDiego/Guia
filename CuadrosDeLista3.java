 ...
 * @author info6
 */
public class CuadrosDeLista3 extends javax.swing.JFrame {

    /**
     * Creates new form CuadrosDeLista
     */
    public CuadrosDeLista3() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuadrosDeLista3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CuadrosDeLista3().setVisible(true);
            }
        });
    }
